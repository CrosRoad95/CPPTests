...
CLuaArgument::CLuaArgument(const char* szString)
{
	...
	strcpy_s(m_szString, strlen(szString), szString);
}
...
CLuaArgument::CLuaArgument(lua_State* luaVM, uint uiArgument)
{
    ...
    switch (m_iType)
    {
        ...
        case LUA_TSTRING:
        {
            if (Argument.m_szString)
            {
				...
				strcpy_s(m_szString, strlen(Argument.m_szString), Argument.m_szString);
            }
...
void CLuaArgument::Read(lua_State* luaVM, uint uiArgument)
{
    ...
    if (m_iType != LUA_TNONE)
    {
        ...
        switch (m_iType)
        {
            ...
            case LUA_TSTRING:
            {
                ...
                strcpy_s(m_szString, strlen(szLuaString), szLuaString);
                break;
            }
